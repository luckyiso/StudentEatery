...
<body>
    <div class="background">
        ...
        <div class="EditProductWindow">
            <div>Изменение товара</div>
                <form id="EditProductFields">
                        ...
                        <input type="text" name="productDescription" placeholder="Новое описание товара">
                        <input type="text" name="productPrice" placeholder="Новая цена товара">
                        <input type="file" name="productImg" accept="image/png">
                        ...
                        <button type="submit" class="EditProduct">Подтвердить</button>
                </form>
            </div>
        </div>
    </div>
